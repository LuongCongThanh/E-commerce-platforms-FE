    ...
    <section ref={containerRef} className="relative overflow-hidden pt-12 pb-16 md:pt-24 md:pb-32">
      ...
      <div className="container mx-auto flex flex-col items-center gap-8 px-4 md:flex-row md:gap-12 lg:gap-20">
        ...
        >
          ...
          <p className="max-w-md text-base leading-relaxed text-neutral-600 md:text-lg dark:text-neutral-400">{hero.subtitle}</p>
          ...
          <div className="flex flex-wrap gap-3 md:gap-4">
            ...
            >
              <Link href={`/${locale}/products`}>{hero.cta}</Link>
            </Button>
            <Button
              asChild
              size="lg"
            ...
            >
              <Link href={`/${locale}/categories/sale`}>{hero.ctaSale}</Link>
            </Button>
          </div>

          <div className="opacity-70 transition-opacity hover:opacity-100">
            <TrustBadgeList items={hero.trustItems} />
          </div>
        </motion.div>
            ...
            >
              ...
              <div className="relative flex h-full w-full items-center justify-center">
                ...
                <div className="relative z-10 h-full w-full transition-transform duration-500 hover:scale-110">
                  <Image src={hero.image} alt={hero.title} fill className="object-contain" priority sizes="(max-width: 768px) 100vw, 50vw" />
                </div>
              </div>
            </motion.div>
