...
@theme {
  ...
  --color-primary-400: oklch(0.7 0.19 25);
  ...
  --color-primary-900: oklch(0.26 0.1 25);
  ...
  --color-neutral-300: oklch(0.85 0.01 30);
  --color-neutral-400: oklch(0.72 0.01 30);
  --color-neutral-500: oklch(0.58 0.01 30);
  ...
  --color-neutral-950: oklch(0.1 0.003 30);

  /* ── Semantic ───────────────────────────────────────────────────────── */
  --color-success-50: oklch(0.97 0.03 145);
  --color-success-500: oklch(0.6 0.18 145);
  ...
  --color-error-700: oklch(0.42 0.2 10);
...
@layer base {
  :root {
    ...
    --secondary-foreground: oklch(0.26 0.1 25);
    --muted: oklch(0.96 0.006 30);
    --muted-foreground: oklch(0.58 0.01 30);
...
export const productColumns: ColumnDef<AdminProduct>[] = [
  ...
  { accessorKey: 'price', header: 'Giá', cell: ({ row }) => formatCurrency(row.getValue('price')) },
  { accessorKey: 'stock', header: 'Tồn kho' },
  { accessorKey: 'status', header: 'Trạng thái', cell: ({ row }) => <Badge>{row.getValue('status')}</Badge> },
