...
| **Base component**  | Primitive UI trong `shared/components/base` — bản vendor của shadcn/ui, theo sát upstream (không fork tự do), không mang business rule. Tuỳ biến theo domain nằm ở tầng tiêu thụ, không sửa trực tiếp vào Base component. |
